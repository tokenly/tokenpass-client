        ...
        <div class="row">
            <div class="col-md-9">
                ...
                @if ($synced)
                    ...
                    <p>To make changes to your account, please <a target="_blank" href="https://tokenpass.tokenly.com">edit your Tokenly Account</a> and then Sync your account again.</p>
